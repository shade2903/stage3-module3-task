...
public class ReadTagByIdCommand extends AbstractCommand<TagDtoRequest, TagDtoResponse, Long> implements Command {
    public ReadTagByIdCommand(BaseController<TagDtoRequest, TagDtoResponse, Long> controller, Scanner scanner) {
